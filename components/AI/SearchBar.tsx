    ...
    <form onSubmit={submit} className="w-full flex justify-center my-3">
         {!autoScroll && (
          <button
            ...
            className="absolute bottom-10 right-[25vw] w-7 h-7 flex flex-row items-center justify-center text-[#2e147e] bg-[#2000c1]/25 rounded-lg shadow-lg hover:bg-[#2000c1]/20 active:scale-90 duration-300  transition"
          >
            <ChevronDown />
          </button>
        )}
